...
class VisualSampleEntry(SampeEntry):
    ...
    def decode(self, file_strm):
        ...
        self.reserved1 = file_strm.ReadUInt16()
        self.offset += UInt16ByteLen
        ...
        self.width = file_strm.ReadUInt16()
        self.offset += UInt16ByteLen

        self.height = file_strm.ReadUInt16()
        self.offset += UInt16ByteLen

        self.horizresolution = file_strm.ReadUInt32()  # 0x00480000 # 72 dpi
        self.offset += UInt32ByteLen

        self.vertresolution = file_strm.ReadUInt32()  # 0x00480000 # 72 dpi
        self.offset += UInt32ByteLen

        self.reserved2 = file_strm.ReadUInt32()
        self.offset += UInt32ByteLen

        self.frame_count = file_strm.ReadUInt16()
        self.offset += UInt16ByteLen

        self.compressorname = file_strm.ReadByte(len(self.compressorname))
        self.offset += UInt8ByteLen * len(self.compressorname)

        self.depth = file_strm.ReadUInt16()  # 0x0018
        self.offset += UInt16ByteLen

        self.pre_defined2 = file_strm.ReadInt16()  # -1
        self.offset += UInt16ByteLen
