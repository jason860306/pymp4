...
class DependencyPointer(object, SLExtensionDescriptor):
    """
    ...
    def __init__(self, offset=0, descr_tag=DescrTag_DependencyPointerTag):
        super(DependencyPointer, self).__init__(offset, descr_tag)
        self.reserved = 0
        self.mode = 0
        self.hasESID = 0
        self.dependLen = 0
